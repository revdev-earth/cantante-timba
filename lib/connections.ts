...
const DEFAULT_POSITIONS: Record<string, Point> = {
  ...
  "Doble tiempo": { x: 834.2181651539355, y: 801.8220018011663 },
  ...
  Tarro: { x: 320, y: 870 },
  "Pa dentro pa fuera": { x: 448.3344437717857, y: 1317.6688819396688 },
...
const DEFAULT_EDGES: Edge[] = [
  ...
  { from: "Saluda la rueda", to: "Fly" },
  { from: "Saluda la rueda", to: "Fly doble" },
  ...
  { from: "Doble tiempo", to: "Americana" },
  { from: "Doble tiempo", to: "Americano" },
  { from: "Doble tiempo", to: "Sabrosura" },
